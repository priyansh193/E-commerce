          ...
          <div>
            ...
            <div className="flex gap-3">
              ...
              >
                <p
                  className={`${
                    sizes.includes("6") ? "bg-pink-100" : "bg-slate-200"
                  } px-3 py-1 cursor-pointer`}
                >
                  6
                </p>
