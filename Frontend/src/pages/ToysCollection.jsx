...
function ToysCollection() {
  ...
  useEffect(() => {
          const filter = products.filter((item) => item.category === 'Books & Toys')
    ...
    <div className='flex flex-col sm:flex-row gap-1 sm:gap-10 pt-10 border-t'>
        ...
        <div className={`border border-gray-300 pl-5 py-3 mt-6 ${showFilter ? '' : 'hidden '} sm:block`}>
          ...
          <div className='flex flex-col gap-2 text-sm font-light text-gray-700'>
            <p className='flex gap-2'>
              <input className='w-3' type="checkbox" value={'Men'} /> Books
            </p>
            <p className='flex gap-2'>
              <input className='w-3' type="checkbox" value={'Women'} /> Toys
            </p>
      ...
      <div className='flex-1'>
        <div className='flex justify-between text-base sm:text-2xl mb-4'>
          <Title text1={'Books & Toys'} text2={'COLLECTION'}/>
          {/* Product Sort */}
